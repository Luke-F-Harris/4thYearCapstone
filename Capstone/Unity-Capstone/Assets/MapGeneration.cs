...
public class MapGeneration : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < numberOfIslands; i++)
        {
            ...
            player = GameObject.FindGameObjectWithTag("StartingPos_Player");
        ...
        //         //need the pointinside to be false and islandoverlap to be false
        //     } while ( PointInsideSquare(genPosition) || islandOverLap(genPosition)); // checking if in the range of the player
    ...
    // public bool PointInsideSquare(Vector2 islandLoc) {

    //     Debug.Log(Square.RectTransform.Min);
    //     return false;
    // }
