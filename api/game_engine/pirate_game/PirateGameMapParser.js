const GameMap = require('./PirateGameMap');
...
class GameMapParser {
    ...
    _parseIslands() {
        const numberOfIslands = this._nextInt();
        const islandParams = mapRange(numberOfIslands, () => this._nextIslandParams());

        this.map.addIslands(islandParams);
    }
